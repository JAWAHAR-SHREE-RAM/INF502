...
def odd_even_filter(numbers):
    ...
    for i in numbers:
        if (i % 2 == 0):                        #Checking the list for even numbers
            ...
            odd_list.append(i)                  #Adding the odd numbers to the empty odd numbers list
    print("Even lists:", even_list)             #Printing the update even list
    print("Odd lists:", odd_list)               #Printing the update odd list
